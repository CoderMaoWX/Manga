...
class WebVC: BaseVC {
    ...
    override func configNavgationBar() {
        super.configNavgationBar()
        navigationItem.rightBarButtonItem = UIBarButtonItem(image: UIImage(named: "nav_reload"), style: .plain, target: self, action: #selector(reloadWebView))
    }
